/// Tests that nanites can be activated
/datum/unit_test/nanites

/datum/unit_test/nanites/Run()
/*
	var/turf/chamber_loc = run_loc_floor_bottom_left
	var/turf/controller_loc = get_step(run_loc_floor_bottom_left, EAST)
	var/turf/cloud_loc = get_step(run_loc_floor_bottom_left, NORTHEAST)
